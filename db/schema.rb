...
ActiveRecord::Schema[7.0].define(version: 2023_12_04_082515) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "matching_times", force: :cascade do |t|
    t.bigint "reservation_id", null: false
    t.datetime "matching_data", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "question_id", null: false
    t.index ["question_id"], name: "index_matching_times_on_question_id"
    t.index ["reservation_id"], name: "index_matching_times_on_reservation_id"
  end
  ...
  add_foreign_key "matching_times", "questions"
  add_foreign_key "matching_times", "reservations"
